  ...
  const posts = [
    {
      ...
      excerpt:
        "We explore the breakthrough technology behind our newest driver array and what it means for the audiophile community.",
      category: "Innovation",
      author: "Marcus Chen",
      date: "Oct 12, 2024",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Announcing our 2030 roadmap for a completely sustainable global supply chain and the partners helping us get there.",
    ...
    },
    {
      ...
      excerpt:
        "Why we believe minimal design isn't just an aesthetic, but a productivity requirement in the remote age.",
      category: "Design",
      author: "Elena Rod",
      date: "Oct 08, 2024",
      image:
    ...
    <div className="py-24 max-w-7xl mx-auto px-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-16">
        ...
        <div className="flex gap-4 mt-6 md:mt-0">
          <button className="px-6 py-2 bg-indigo-600 text-white rounded-full text-sm font-bold">
            Latest
          </button>
          <button className="px-6 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-bold hover:bg-gray-200">
            Engineering
          </button>
          <button className="px-6 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-bold hover:bg-gray-200">
            Company
      ...
      <div className="grid grid-cols-1 gap-16">
        {posts.map((post, i) => (
          ...
          >
            <div className="relative aspect-video overflow-hidden rounded-[40px] shadow-2xl shadow-gray-200">
              <img
                src={post.image}
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl font-black text-gray-900 group-hover:text-indigo-600 transition-colors">
                {post.title}
              </h2>
