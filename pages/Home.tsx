    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-8">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-white leading-[0.9] md:leading-[0.95] tracking-tighter">
            {" "}
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-medium">
            Discover a curated collection of cutting-edge technology and premium
            essentials designed for the modern trailblazer.
          </p>
          ...
          {[
            {
              ...
              desc: "Global shipping in under 48 hours for premium members.",
            },
            {
              icon: Shield,
              title: "Titanium Security",
              desc: "Every transaction is protected by bank-grade encryption.",
            },
            {
              icon: Globe,
              title: "Global Network",
              desc: "Over 500 partner branches across all major continents.",
            },
            {
              icon: Award,
              title: "Curated Excellence",
              desc: "Only the top 1% of tech products make it into our store.",
            },
          ].map((item, i) => (
