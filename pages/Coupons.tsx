...
const ProductSelector: React.FC<ProductSelectorProps> = ({
  selectedIds, onToggle, onRemove, onClearAll,
  search, onSearchChange, showDropdown, onFocus,
  filteredList, containerRef, allProducts,
}) => (
  <div className="mt-4 space-y-2">
    ...
    <div className="relative" ref={containerRef}>  {/* ← containerRef here */}
